...
export async function collectWayback(db) {
    ...
    console.log(`wayback : ${projects} projets uniquement issus des archives (instantané ${SNAPSHOT_DATE}) + snapshots historiques`);
}
function toInt(v) {
    if (!v)
        return null;
