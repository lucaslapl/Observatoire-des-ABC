...
export const STATUT_AGREGEG = ["a_venir", "en_cours", "termine", "inconnu"] as const;
export type StatutAgrege = (typeof STATUT_AGREGEG)[number];

// --- La catégorie applicative correspondant à l'énoncé de la demande ---
export type CategorieABC = "va_debuter" | "en_cours" | "termine" | "inconnu";
